<?php
// Single source of truth for site content. Shared by every page.

$profile = [
    'name'         => 'Marcus Loo',
    'role'         => 'Senior Full Stack Engineer',
    'title'        => 'Project Lead & Senior Full Stack Engineer',
    'company'      => 'Tess Sdn Bhd',
    'location'     => 'Kuala Lumpur, Malaysia',
    'since'        => '2020',
    'availability' => 'Open to conversations',
    'summary'      => 'I architect and build scalable full-stack systems — robust PHP/Laravel backends, clean APIs, and interfaces that stay out of the way.',
];
...
$terminal = [
    ['cmd' => 'whoami', 'out' => ['Marcus Loo — Senior Full Stack Engineer']],
    ['cmd' => 'cat ./now.txt', 'out' => ['Project Lead @ Tess Sdn Bhd', 'Kuala Lumpur, Malaysia']],
    ['cmd' => 'ls ./stack', 'out' => ['php   laravel   vue   mysql   linux']],
    ['cmd' => './contact --email', 'out' => ['marcuslooek@gmail.com']],
];

$content = [
    'about' => [
        "Hello! My name is Marcus and I enjoy creating things that live on the internet. Technology has been a huge passion of mine — especially being able to learn and use tech in as many different ways as I can imagine. I'm highly open to learning new things, even outside my own field, and I strongly believe in work culture and teamwork.",
    ...
    // Rendered as a mono key/value spec sheet next to the About prose.
    'spec' => [
        'role'      => 'Project Lead, Senior Full Stack Engineer',
        'company'   => 'Tess Sdn Bhd',
        'location'  => 'Kuala Lumpur, MY',
        'since'     => '2020 — present',
        'focus'     => 'Backend architecture, APIs, internal tooling',
    ...
    'experiences' => [
        [
            ...
            'details' => [
                ...
                'Work closely with stakeholders to refine requirements and optimise system design before development begins.',
        ...
        [
            ...
            'details' => [
                ...
                'Assisted other developers working on other systems by providing technical support and integrating enhancements to optimise sales processes.',
            ],
        ],
        [
    ...
    'projects' => [
        [
            ...
            'description' => 'Internal library that accelerates custom software development by eliminating repetitive CRUD and boilerplate.',
            'key_points'  => [
                '70–80% faster development',
                'Plug-and-play CRUD, search, roles, file handling',
